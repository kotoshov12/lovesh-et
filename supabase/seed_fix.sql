...
values
  ('טי-שירט גרפי וינטג''', 'חולצות', 40, null, 'Vintage', 'M', 'מצב טוב', 'Vintage · M · מצב טוב', 'סטריטוור',
  ...
  ('חולצת טי לבנה בייסיק', 'חולצות', 30, null, 'Basic', 'L', 'כמו חדש', 'Basic · L · כמו חדש', 'בייסיק',
  ...
  ('ג''ינס מאמא Levi''s', 'מכנסיים', 70, 110, 'Levi''s', 'M', 'מצב טוב', 'Levi''s · M · מצב טוב', 'דנים',
  ...
  ('שמלת ערב אדומה', 'שמלות', 85, null, 'Mango', 'S', 'מצב מעולה', 'Mango · S · מצב מעולה', 'ערב',
  ...
  ('שמלת קוקטייל סגולה', 'שמלות', 80, 130, 'Zara', 'M', 'מצב מעולה', 'Zara · M · מצב מעולה', 'ערב',
  ...
  ('חצאית מידי פליסה', 'חצאיות', 45, 70, 'Vintage', 'S', 'מצב טוב', 'Vintage · S · מצב טוב', 'קיץ',
  ...
  ('סניקרס ואנס בורדו', 'נעליים', 85, null, 'Vans', '40', 'מצב טוב', 'Vans · 40 · מצב טוב', 'הנעלה',
  ...
  ('ז''קט ג''ינס אוברסייז', 'מעילים', 70, null, 'Vintage', 'L', 'מצב מעולה', 'Vintage · L · מצב מעולה', 'אאוטרוור',
  ...
  ('מעיל בומבר חום', 'מעילים', 90, null, 'Zara', 'M', 'כמו חדש', 'Zara · M · כמו חדש', 'אאוטרוור',
  ...
  ('תיק קרוסבודי שחור', 'אקססוריז', 70, null, 'Designer', 'One Size', 'מצב מעולה', 'Designer · One Size · מצב מעולה', 'אקססוריז',
